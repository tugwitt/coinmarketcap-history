...
def getDataFor(cryptocurrencies, start_date, end_date, proxy_path, fields = [], with_async = False, DOWNLOAD_DIR = None):
    ...
    if with_async:
        ...
        result_dict = async_utils.get_htmls(cryptocurrencies, start_date, end_date, proxy_path)
    else:
        # otherwise, extract data sequentially
        result_dict = utils.get_htmls(cryptocurrencies, start_date, end_date, proxy_path)
...
def main(args=None):
    ...
    cryptocurrencies, start_date, end_date, with_async = args.currency, args.start_date, args.end_date, args.with_async

    cryptocurrencies = cryptocurrencies.split(',')

    df = getDataFor(cryptocurrencies, start_date, end_date, with_async = with_async)
